...
<html lang="en">
	...
	<title>INVOICE | <?php echo $_REQUEST["package"]; ?></title>
<script>
function printit()
{
...
<body>
<button id="printbtn" onclick="printit()" class="btn btn-success">Print</button> ---------------- Eshop Helpline: +91 9923069360
<center><h1>EShop.com</h1></center><br /><br />
...
?>
<br />
<i>This package contains the following <b>items</b>: </i>
<?php
...
echo "</table><br /><br /><br /><br /><h1>TOTAL:".$total."</h1>";
?>
